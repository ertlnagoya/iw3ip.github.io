...
**基本** で全体像を確認し、**機能拡張** で安全な共有や段階アクセスを扱い、**知能統合** で AI 連携まで示します。

> 先に [環境構築](../setup/index.md) を済ませてからこのページに進んでください。
...
| **Part 2 / 認証してみよう (SSI)** | ✓ | – | – | ✓ | – | – |
| **Part 2 / マーケットと連携 (v2)** | ✓ | ✓ | ✓ | ✓ | – | – |
| **Part 2 / データ処理を入れる** | ✓ | ✓ <small>(Tier 3 実機時)</small> | ✓ <small>(同)</small> | ✓ | – | ✓ <small>(OpenCV / VLM 任意)</small> |
| **Part 3 / 知能統合** | ✓ | – | – | – | – | ✓ <small>(LLM)</small> |

### 主に使う VC (Verifiable Credential) の種類

| サブグループ | Consent | Viewer | Service | Purchase&shy;Viewer | Seller | DataUser |
|---|:-:|:-:|:-:|:-:|:-:|:-:|
| Part 2 / 認証してみよう | ✓ | ✓ | ✓ | – | – | – |
| Part 2 / マーケットと連携 (v2) | – | – | ✓ | ✓ | ✓ | – |
| Part 2 / データ処理を入れる | – | – | – | ✓ | – | ✓ |
...
実機がなくても、Home Assistant のシミュレータでハンズオン全体を確認できます。
最初に試すのに適しています。
...
[環境構築のミニ辞書](../setup/index.md) を参照してください。

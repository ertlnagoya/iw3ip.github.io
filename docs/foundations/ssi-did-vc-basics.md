...
SSI、DID、VC は似た文脈でまとめて登場するため、最初は区別しにくい。  
...
従来の ID 管理では一事業者がアカウント情報と権限を握るため、利用者は他サービスへの持ち運びや第三者検証が難しい。SSI では利用者や組織が資格情報を自ら保持し、必要な場面で提示・検証します。
...
サンプルの目的と今後の拡張対象を切り分けるために、先に明示しておきます。

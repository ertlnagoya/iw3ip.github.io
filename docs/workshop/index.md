...
<div class="iw3ip-phase-grid">
  <div class="iw3ip-phase-card iw3ip-phase-1">
    ...
    <p class="iw3ip-phase-links"><a href="../hands-on/huskylens2.md">HUSKYLENS2</a> / <a href="../hands-on/webcam.md">USBウェブカメラ</a> / <a href="../hands-on/ha-ssi-publisher.md">HA x SSI Publisher</a></p>
  </div>
...
- HUSKYLENS2 がある: [HUSKYLENS2サンプル](../hands-on/huskylens2.md)
- USB カメラのみ: [USBウェブカメラサンプル](../hands-on/webcam.md)
- Home Assistant と SSI の流れを見せたい: [HA x SSI Publisherサンプル](../hands-on/ha-ssi-publisher.md)
- 閲覧側も見せたい: [スマホ閲覧アプリ](../hands-on/mobile-viewer.md)
